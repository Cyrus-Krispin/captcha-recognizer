...
class CaptchaSegmenter:
    ...
    def save_processed_image(self):
        """Saves the processed image with a given suffix."""
        error_output_folder = "error_images"
        ...
        error_image_path = os.path.join(error_output_folder, f"{base_name}.png")
        cv2.imwrite(error_image_path, self.processed_image)
        print(f"Saved processed image to {error_image_path}")
